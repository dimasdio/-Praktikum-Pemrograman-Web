...
<body>
    ...
    echo "<h1>BIO DATA</h1>";
    echo "<table width='60%'>";
    echo "<tr><td class='atas' width='30%'>Nama :</td><td width='30%'><input type='text' name='name' value='Dio Dimas Ramadhan'></td></tr>";
    ...
    echo "<tr><td class='atas'>Foto :</td><td><img src='dimas.jpg' width='200px'></img></td></tr>";
